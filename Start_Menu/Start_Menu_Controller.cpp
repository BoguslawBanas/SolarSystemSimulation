...
void Start_Menu_Controller::requestDrawing(){
    switch(this->state){
        case START_MENU1:{
            this->view->drawStartMenu1(this->model->getButton1(), this->model->getButton2(), this->model->getButton3(), this->camera);
        } break;
        case START_MENU2:{
            this->view->drawStartMenu2(this->model->getButton1(), this->model->getButton2(), this->model->getButton3(), this->camera);
        } break;
    }
}